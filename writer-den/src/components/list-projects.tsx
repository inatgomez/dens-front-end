  ...
  return (
    <div className='bg-slate-700 min-h-screen'>
      <div className='mx-auto max-w-2xl px-4 py-4 sm:px-6 sm:py-8 lg:max-w-7xl lg:px-8'>
        <h2 className='text-xl text-neutral-50 font-bold'>Projects</h2>
        ...
        <div className='mt-4 grid grid-cols-6 gap-x-6 gap-y-10 xl:gap-x-8'>
          {projects.map((project) => (
            <Link
              ...
              className='group'
            >
              <div className='max-h-40 max-w-sm overflow-hidden rounded-lg bg-violet-500 shadow-sm shadow-violet-600 p-4'>
