...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-9 w-1/3 items-center justify-between whitespace-nowrap rounded-md border border-slate-800 bg-slate-900 px-3 py-2 text-sm text-slate-50 shadow-sm ring-offset-slate-900 placeholder:text-slate-50 focus:outline-none focus:ring-1 focus:ring-slate-300 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
      className
    )}
    {...props}
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDownIcon className='h-4 w-4 text-slate-50' />
